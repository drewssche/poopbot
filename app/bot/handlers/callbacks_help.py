...
def _notifications_text(
    ...
    q2_q3_extra = (
        "Уточняющие вопросы публикуются автоматически после Q1."
        if q2_q3_enabled
        else "Автопост уточняющих вопросов выключен: их можно открыть вручную кнопкой «🧻 Уточняющие вопросы» в Q1."
    )
    return (
        "🔔 Уведомления\n\n"
